...
def extract_widgets(img_path, color=(0, 0, 255)):
    ...
    cv2.imwrite('D:\\iSE\\2022_Summer\\AutoArm\\RoboTest\\image\\temp\\' + otherStyleTime + '.jpg', checkContour)
    return rectangle_list


print(extract_widgets(r'D:\iSE\2022_Summer\AutoArm\RoboTest\opensource_code\image\1.jpg'))
